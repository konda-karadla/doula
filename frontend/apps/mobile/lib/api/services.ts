...
/**
 * Mobile API Services
 * Uses mobile-specific API client with SecureStore token management
 * All services follow the same pattern as web but adapted for React Native
 */
...
export const labService = {
  upload: (file: any, onProgress?: (progress: number) => void): Promise<LabResult> =>
    api.uploadFile(apiEndpoints.labs.upload, file, onProgress),
